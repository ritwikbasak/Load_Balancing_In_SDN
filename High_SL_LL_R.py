...
class Controller(RyuApp):
    ...
    def handle_tcp_packet(self, datapath, in_port, ip_header, parser, dst_mac, src_mac):
        ...
        if ip_header.dst == self.VIRTUAL_IP:
            self.selected_server = self.load_balancer.get_server(self.server_weight, self.throughput_list, self.no_of_servers)
    ...
    def flow_stats_reply_handler(self, ev):
        ...
        if self.index == 0:
            ...
            for link_stats in self.link_statistics:
                ...
                self.server_link_throughput.append(throughput / (100000))  

            print("**************Throughput_list********************")
            print(self.server_link_throughput)
            #self.load_balancer.least_loaded(self.server_link_throughput)
            ...
            for link_stats in self.link_statistics:
                ...
                self.server_link_throughput.clear()
