...
class Controller(RyuApp):
    ...
    def round_robin(self):
        self.selected_server = (self.selected_server + 1) % self.no_of_servers
        print(f"New server at load: {self.selected_server}")
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ipMacMap = {}
        for i in range(0, self.no_of_servers):
    ...
    def packet_in_handler(self, ev):
        ...
        if eth.ethertype == ether_types.ETH_TYPE_IP:
            ...
            if packet_handled:
                ...
                datapath.send_msg(parser.OFPPacketOut(datapath=datapath, in_port=ofproto.OFPP_ANY,
                                                 data=pkt.data, actions=actions, buffer_id=0xffffffff))
                return
    ...
    def handle_load(self,raw_data):
        ...
        server_host=(load_info.split('-')[1])[:-1]
        print(f"Load = {load}")
